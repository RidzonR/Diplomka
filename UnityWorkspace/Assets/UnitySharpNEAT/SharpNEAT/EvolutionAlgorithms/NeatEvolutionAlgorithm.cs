...
namespace SharpNeat.EvolutionAlgorithms
{
        ...
        where TGenome : class, IGenome<TGenome>
    {
        ...
        public void Initialize(IGenomeListEvaluator<TGenome> genomeListEvaluator,
                                        IGenomeFactory<TGenome> genomeFactory,
                                        List<TGenome> genomeList, int generation)
        {
            Initialize(genomeListEvaluator, genomeFactory, genomeList);
            _currentGeneration = (uint)generation;
        }
