...
namespace SharpNeat.Genomes.Neat
{
    ...
    public class ConnectionGeneListBuilderCustom
    {
        ...
        /// </summary>
        public ConnectionGeneListBuilderCustom(int connectionCapacity)
        {
        ...
        public void TryAddGene(ConnectionGene connectionGene, NeatGenomeCustom parentGenome, bool overwriteExisting)
        {
        ...
        /// Note. This same logic is implemented on NeatGenomeCustom.IsConnectionCyclic() but against slightly 
