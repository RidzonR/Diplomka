...
namespace SharpNeat.Genomes.Neat
{
    ...
    [Serializable]
    public class NeatGenomeCustom : IGenome<NeatGenomeCustom>, INetworkDefinition
    {
        #region Instance Variables

        [SerializeField]
        NeatGenomeFactoryCustom _genomeFactory;
        ...
        /// </summary>
        public NeatGenomeCustom(NeatGenomeFactoryCustom genomeFactory,
                          uint id,
        ...
        /// Copy constructor.
        /// </summary>
        public NeatGenomeCustom(NeatGenomeCustom copyFrom, uint id, uint birthGeneration)
        {
        ...
        #region IGenome<NeatGenomeCustom> Members
        ...
        /// For a NeatGenomeCustom we return the number of connection genes since a neural network's
        ...
        public NeatGenomeCustom CreateOffspring(uint birthGeneration)
        {
            // Make a new genome that is a copy of this one but with a new genome ID.
            NeatGenomeCustom offspring = _genomeFactory.CreateGenomeCopy(this, _genomeFactory.NextGenomeId(), birthGeneration);
        ...
        /// <param name="birthGeneration">The current evolution algorithm generation. 
        /// Assigned to the new genome at its birth generation.</param>
        public NeatGenomeCustom CreateOffspring(NeatGenomeCustom parent, uint birthGeneration)
        {
            ...
            ConnectionGeneListBuilderCustom connectionListBuilder = new ConnectionGeneListBuilderCustom(_connectionGeneList.Count +
        ...
        /// </summary>
        public NeatGenomeFactoryCustom GenomeFactory
        {
            ...
            set
            {
                if (null != _genomeFactory)
                {
                    throw new SharpNeatException("NeatGenomeCustom already has an assigned GenomeFactory.");
                }
            ...
            for (; ; )
            {
                ...
                switch (outcome)
                {
                    ...
                    case 4:
                        ...
                        break;
                    default:
                        throw new SharpNeatException(string.Format("NeatGenomeCustom.Mutate(): Unexpected outcome value [{0}]", outcome));
                }
        ...
        public NetworkConnectivityData GetConnectivityData()
        {
            ...
            // NeatGenomeCustom(s) have connectivity data pre-calculated, as such we point to this data rather than copying or
