...
namespace SharpNeat.Genomes.Neat
{
    ...
    /// </summary>
    public class NeatGenomeParametersCustom
    {
        #region Constants
        ...
        /// </summary>
        public NeatGenomeParametersCustom()
        {
            _activationFn = BipolarSigmoid.__DefaultInstance;
        ...
        /// Construct with default set of parameters.
        /// </summary>
        public NeatGenomeParametersCustom(bool justWeightMutation)
        {
            _activationFn = BipolarSigmoid.__DefaultInstance;

            _connectionWeightRange = DefaultConnectionWeightRange;
            _initialInterconnectionsProportion = 0;
            _disjointExcessGenesRecombineProbability = 0;
            _connectionWeightMutationProbability = 1f;
            _addNodeMutationProbability = 0;
            _addConnectionMutationProbability = 0;
            _nodeAuxStateMutationProbability = 0;
            _deleteConnectionMutationProbability = 0;
        ...
        /// Copy constructor.
        /// </summary>
        public NeatGenomeParametersCustom(NeatGenomeParametersCustom copyFrom)
        {
        ...
        /// </summary>
        public static NeatGenomeParametersCustom CreateSimplifyingParameters(NeatGenomeParametersCustom copyFrom)
        {
            NeatGenomeParametersCustom newParams = new NeatGenomeParametersCustom(copyFrom);
